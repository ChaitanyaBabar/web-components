...
import { AnnotateServiceContext } from "../annotate-service";
import { AnnotateUtilityContext } from "../annotate-utility";
...
import { AuditTrailServiceContext } from "../audit-trail-service";
import { OverlayInfoImpl } from "../model/overlay.info";
let AuditTrail = class AuditTrail extends LitElement {
    constructor() {
        super();
        ...
        this.config = { "top": 100, "skip": 0, "orderby": "creationTime desc", "reference": "" };
    ...
    fetchAuditData() {
        fetch('assets/parallel_flow.json').then(response => response.json()).then(data => {
            const pd = window['process-diagram'];
            var diagram = pd.createDiagram(this._mainSvgContainer, data, function onChange(context) {
            ...
            diagram.invoke(['eventBus', function (eventBus) {
            ...
            mockCall.then((response) => {
                ...
                for (let i = 0; i < overlayTodos.length; i++) {
                    ...
                    overLayInfo.overlayClickCallback = (event) => {
                    ...
                    this._diagram.invoke(['eventBus', 'annotationOverlays', function (eventBus, annotationOverlays) {
    ...
    actualTodos(flowElements, auditTrailData) {
        const overlays = [];
    ...
    registerSvgHandlers() {
        this.svgMouseOverHandler = (evt) => this.handleSvgMouseOver(evt);
        this.svgMouseOutHandler = (evt) => this.handleSvgMouseOut(evt);
        this.objectMouseClickHandler = (evt) => this.handleObjectMouseClick(evt);
        window.objectMouseOver = this.svgMouseOverHandler;
        window.objectMouseOut = this.svgMouseOutHandler;
        window.objectMouseClick = this.objectMouseClickHandler;
    }
    ...
    removeExistingWrapper(currentProcessingElement) {
    ...
    createWrapperForElement(currentProcessingElement, evt) {
...
], AuditTrail.prototype, "selectedWorkItem", void 0);
__decorate([
    property({ type: String })
], AuditTrail.prototype, "processInstance", void 0);
__decorate([
    property({ type: String, attribute: 'svg-file' })
], AuditTrail.prototype, "svgFile", void 0);
__decorate([
    state()
], AuditTrail.prototype, "_svgContent", void 0);
__decorate([
    state()
], AuditTrail.prototype, "diagramModel", void 0);
__decorate([
    property({ state: true, type: Object })
], AuditTrail.prototype, "auditTrailData", void 0);
__decorate([
    consume({ context: AnnotateServiceContext })
], AuditTrail.prototype, "_annotateService", void 0);
__decorate([
    consume({ context: AnnotateUtilityContext })
], AuditTrail.prototype, "_annotateUtility", void 0);
__decorate([
    consume({ context: AuditTrailServiceContext })
], AuditTrail.prototype, "_auditTrailService", void 0);
__decorate([
    query('#main-svg-container')
], AuditTrail.prototype, "_mainSvgContainer", void 0);
AuditTrail = __decorate([
